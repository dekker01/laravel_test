...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h1 class="mt-3"> FROM TAMBAH DATA</h1>
            ...
            <form method="post" action="{{ url('/students') }}">
                ...
                <div class="form-group">
                    <label for="nama">Nama Siswa</label>
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Input Nama" name="nama" value="{{ old('nama')}}"> @error('nama') <div class="invalid-feedback">{{ $message }} </div> @enderror
                </div>
